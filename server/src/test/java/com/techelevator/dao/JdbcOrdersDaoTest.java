...
public class JdbcOrdersDaoTest extends BaseDaoTests {
    private static  final Orders order1 = new Orders(1, "nameTest1", "unkown", "unknown", "unknown", "unknown", "site");
    private static  final Orders order2 = new Orders(2, "nameTest2","unkown", "unknown", "unknown", "unknown", "site");
    private static  final Orders order3 = new Orders(3, "nameTest3","unkown", "unknown", "unknown", "unknown", "site");
